defmodule BbbLti.Meetings do
  ...
  ## Examples
      ...
      iex> list_meetings(unit_id)
      [%Meeting{}, ...]

  """
  def list_meetings(unit_id) do
    from(m in Meeting, where: m.unit_id == ^unit_id)
    |> Repo.all()
  end
  ...
  def get_meeting(meeting_id), do: Repo.get_by(Meeting, meeting_id: meeting_id)
